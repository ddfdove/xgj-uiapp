	...
	<view class="write_list_page">
		<div class="write_list_nav">
			<div class="write_list_nav_view" v-if="menuButtonInfo"
				...
				<text
					style="margin-left: 80px;color: #1A1A1A;font-size: 18px; font-weight: 500;font-family: Source Han Sans CN;">添加采购计划</text>
			</div>
		</div>
		<div class="write_list_content">
			...
			<div>
				<div class="write_list_content_item" v-for="(item,index) in list" :key="index"
					@click="goToPage(`/pages/canteen/purchase/info?id=${item.purchaseId}`) "
					...
					<div style="flex:1;display: flex;">
						...
						<span style="flex:1;">日期：{{item.updateTime.substr(0,10)}}</span>
					</div>
				</div>
