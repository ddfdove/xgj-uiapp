		...
		<div class="write_info_content">
			<view class="personForm">
				<view class="flex-row-start formItem">
					...
					<uni-data-select class="select" v-model="form.department" :localdata="deptOptions"
						placeholder="请选择部门" clear></uni-data-select>
          ...
          /> -->
				...
				<view class="flex-row-start formItem">
					...
					<input class="input" type="text" v-model="form.unit" placeholder="请输入单位" />
				</view>
				<view class="flex-row-start formItem">
