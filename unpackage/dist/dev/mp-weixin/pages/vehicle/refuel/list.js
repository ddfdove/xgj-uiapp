...
var _list = _interopRequireDefault(__webpack_require__(/*! ./pages/vehicle/refuel/list.vue */ 305));
// @ts-ignore
...
/* harmony import */ var _list_vue_vue_type_template_id_9acb4290___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./list.vue?vue&type=template&id=9acb4290& */ 306);
    ...
    searchHistory: function searchHistory(value) {
      ...
      if (value == '') {
        ...
        for (var i = 0; i < this.list.length; i++) {
          ...
          //（核心所在，其它都是根据需求来自己写）
          if (this.list[i].orderNumber.indexOf(value) >= 0 | this.list[i].oilNumber.indexOf(value) >= 0) {
